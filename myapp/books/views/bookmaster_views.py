...
class BookMasterCreateView(LoginRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        return reverse_lazy("books_admin:bookmaster_detail", kwargs={"pk": self.object.pk})
...
class BookMasterDetailView(LoginRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        chaptermasters_queryset = self.object.chaptermasters.all().order_by("chapter_number")
        
        # Add pagination
        paginator = Paginator(chaptermasters_queryset, 20)  # 20 chapters per page
            ...
            for language in languages:
                try:
                    ...
                    row['chapters'][language.code] = {
                        ...
                        'url': chapter.get_absolute_url() if hasattr(chapter, 'get_absolute_url') else None
                    }
                except:
                    row['chapters'][language.code] = {
                        'chapter': None,
